...
/**
 * Top-level interface for JWT token validation.
 *
 * <p>Delegates to the full 7-step validation pipeline:
 * preprocessing, parsing, algorithm validation, key lookup,
 * signature verification, claims validation, and post-validation hooks.
 *
...
public interface TokenValidator {
    ...
    /**
     * Validates the given JWT token and returns the verified claims.
     *
     ...
     * @throws InvalidClaimException      if default claim validation fails
     */
    List<TokenClaim> validate(String token)
